...
namespace KlingAI
{
    public partial class KlingAIClient
    {
        ...
        partial void PrepareListImageToVideoTasksArguments(
            ...
            ref int? pageNum,
            ref int? pageSize);
        partial void PrepareListImageToVideoTasksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? pageNum,
            int? pageSize);
        partial void ProcessListImageToVideoTasksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListImageToVideoTasksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List image-to-video tasks<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::KlingAI.TaskListResponse> ListImageToVideoTasksAsync(
            int? pageNum = default,
            int? pageSize = default,
            global::KlingAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListImageToVideoTasksAsResponseAsync(
                pageNum: pageNum,
                pageSize: pageSize,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::KlingAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::KlingAI.AutoSDKHttpResponse<global::KlingAI.TaskListResponse>> ListImageToVideoTasksAsResponseAsync(
            int? pageNum = default,
            int? pageSize = default,
            global::KlingAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListImageToVideoTasksArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListImageToVideoTasksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::KlingAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::KlingAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListImageToVideoTasksAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListImageToVideoTasksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::KlingAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListImageToVideoTasksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::KlingAI.TaskListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::KlingAI.AutoSDKHttpResponse<global::KlingAI.TaskListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::KlingAI.TaskListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
