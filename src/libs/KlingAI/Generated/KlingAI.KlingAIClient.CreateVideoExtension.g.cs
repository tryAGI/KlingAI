...
namespace KlingAI
{
    public partial class KlingAIClient
    {
        ...
        private static readonly global::KlingAI.EndPointSecurityRequirement s_CreateVideoExtensionSecurityRequirement0 =
        ...
        private static readonly global::KlingAI.EndPointSecurityRequirement[] s_CreateVideoExtensionSecurityRequirements =
            new global::KlingAI.EndPointSecurityRequirement[]
            {                s_CreateVideoExtensionSecurityRequirement0,
            };
        partial void PrepareCreateVideoExtensionArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::KlingAI.CreateVideoExtensionRequest request);
        partial void PrepareCreateVideoExtensionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::KlingAI.CreateVideoExtensionRequest request);
        partial void ProcessCreateVideoExtensionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVideoExtensionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::KlingAI.CreateTaskResponse> CreateVideoExtensionAsync(

            global::KlingAI.CreateVideoExtensionRequest request,
            global::KlingAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateVideoExtensionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::KlingAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::KlingAI.AutoSDKHttpResponse<global::KlingAI.CreateTaskResponse>> CreateVideoExtensionAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVideoExtensionArguments(
            ...
            var __authorizations = global::KlingAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVideoExtensionSecurityRequirements,
                operationName: "CreateVideoExtensionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVideoExtensionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::KlingAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::KlingAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateVideoExtension",
                                methodName: "CreateVideoExtensionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVideoExtensionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::KlingAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::KlingAI.ApiException<global::KlingAI.ErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVideoExtensionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::KlingAI.CreateTaskResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::KlingAI.AutoSDKHttpResponse<global::KlingAI.CreateTaskResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::KlingAI.CreateTaskResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::KlingAI.CreateTaskResponse> CreateVideoExtensionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::KlingAI.CreateVideoExtensionRequest
            {
                VideoId = videoId,
                Prompt = prompt,
            ...
            return await CreateVideoExtensionAsync(
                request: __request,
                requestOptions: requestOptions,
