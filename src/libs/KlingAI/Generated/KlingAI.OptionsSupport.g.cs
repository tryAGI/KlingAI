...
namespace KlingAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::KlingAI.AutoSDKRetryOptions Retry { get; set; } = new global::KlingAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::KlingAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::KlingAI.IAutoSDKHook>();
        ...
        public global::KlingAI.AutoSDKClientOptions AddHook(
            global::KlingAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::KlingAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::KlingAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::KlingAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::KlingAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::KlingAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::KlingAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::KlingAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::KlingAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::KlingAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::KlingAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::KlingAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::KlingAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::KlingAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::KlingAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::KlingAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::KlingAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::KlingAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::KlingAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::KlingAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::KlingAI.AutoSDKClientOptions clientOptions,
            global::KlingAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::KlingAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::KlingAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::KlingAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::KlingAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::KlingAI.IAutoSDKHook, global::KlingAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::KlingAI.AutoSDKHookContext context)
        {
