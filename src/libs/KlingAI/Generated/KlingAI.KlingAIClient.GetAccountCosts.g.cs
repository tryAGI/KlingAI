...
namespace KlingAI
{
    public partial class KlingAIClient
    {
        ...
        partial void PrepareGetAccountCostsArguments(
            ...
            ref long startTime,
            ref long endTime,
            ref string? resourcePackName);
        partial void PrepareGetAccountCostsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long startTime,
            long endTime,
            string? resourcePackName);
        partial void ProcessGetAccountCostsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAccountCostsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::KlingAI.AccountCostsResponse> GetAccountCostsAsync(
            long startTime,
            long endTime,
        ...
        {
            var __response = await GetAccountCostsAsResponseAsync(
                startTime: startTime,
                endTime: endTime,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::KlingAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::KlingAI.AutoSDKHttpResponse<global::KlingAI.AccountCostsResponse>> GetAccountCostsAsResponseAsync(
            long startTime,
            long endTime,
            string? resourcePackName = default,
            global::KlingAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAccountCostsArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::KlingAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::KlingAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetAccountCostsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAccountCostsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::KlingAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAccountCostsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::KlingAI.AccountCostsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::KlingAI.AutoSDKHttpResponse<global::KlingAI.AccountCostsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::KlingAI.AccountCostsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
