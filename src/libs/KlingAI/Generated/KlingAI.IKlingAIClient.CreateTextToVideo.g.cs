...
namespace KlingAI
{
    public partial interface IKlingAIClient
    {
        ...
        global::System.Threading.Tasks.Task<global::KlingAI.CreateTaskResponse> CreateTextToVideoAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::KlingAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::KlingAI.AutoSDKHttpResponse<global::KlingAI.CreateTaskResponse>> CreateTextToVideoAsResponseAsync(
