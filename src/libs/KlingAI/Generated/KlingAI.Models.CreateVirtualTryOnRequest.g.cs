...
namespace KlingAI
{
    ...
    public sealed partial class CreateVirtualTryOnRequest
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::KlingAI.JsonConverters.CreateVirtualTryOnRequestModelNameJsonConverter))]
        public global::KlingAI.CreateVirtualTryOnRequestModelName? ModelName { get; set; }
