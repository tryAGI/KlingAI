...
namespace KlingAI
{
    public partial class KlingAIClient
    {
        ...
        private static readonly global::KlingAI.EndPointSecurityRequirement s_CreateVirtualTryOnSecurityRequirement0 =
        ...
        private static readonly global::KlingAI.EndPointSecurityRequirement[] s_CreateVirtualTryOnSecurityRequirements =
            new global::KlingAI.EndPointSecurityRequirement[]
            {                s_CreateVirtualTryOnSecurityRequirement0,
            };
        partial void PrepareCreateVirtualTryOnArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::KlingAI.CreateVirtualTryOnRequest request);
        partial void PrepareCreateVirtualTryOnRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::KlingAI.CreateVirtualTryOnRequest request);
        partial void ProcessCreateVirtualTryOnResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVirtualTryOnResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::KlingAI.CreateTaskResponse> CreateVirtualTryOnAsync(

            global::KlingAI.CreateVirtualTryOnRequest request,
            global::KlingAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateVirtualTryOnAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::KlingAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::KlingAI.AutoSDKHttpResponse<global::KlingAI.CreateTaskResponse>> CreateVirtualTryOnAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVirtualTryOnArguments(
            ...
            var __authorizations = global::KlingAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVirtualTryOnSecurityRequirements,
                operationName: "CreateVirtualTryOnAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVirtualTryOnRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::KlingAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::KlingAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateVirtualTryOn",
                                methodName: "CreateVirtualTryOnAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVirtualTryOnResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::KlingAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVirtualTryOnResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::KlingAI.CreateTaskResponse> CreateVirtualTryOnAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::KlingAI.CreateVirtualTryOnRequest
            {
                ModelName = modelName,
            ...
            return await CreateVirtualTryOnAsync(
                request: __request,
                requestOptions: requestOptions,
