...
namespace KlingAI
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::KlingAI.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::KlingAI.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::KlingAI.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::KlingAI.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::KlingAI.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::KlingAI.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::KlingAI.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::KlingAI.ApiException exception)
        ...
        private static global::KlingAI.AutoSDKRequestOptions CloneRequestOptions(
            global::KlingAI.AutoSDKRequestOptions? source)
        {
            var clone = new global::KlingAI.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
